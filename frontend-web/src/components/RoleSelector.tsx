      ...
      <section className="relative px-4 pt-32 pb-24 bg-[#F3F4EF]">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-8xl font-black tracking-tight leading-[1.0] text-black"
          >
            找工作是为了什么？<br />
            <span className="bg-black text-white px-6 py-4 inline-block transform -rotate-1 shadow-[8px_8px_0px_0px_#F54E00] mt-6">
              是为了不再找工作！
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-gray-800 max-w-3xl mx-auto leading-relaxed font-bold border-b-4 border-black pb-4"
          >
            上 TalentOS，把你的天赋变成终身资产！
          </motion.p>

          <div className="flex flex-wrap justify-center gap-4 pt-4">
            <span className="px-4 py-2 bg-[#F54E00] text-white font-black rounded-lg shadow-[4px_4px_0px_0px_#000] border-2 border-black">
              想创业的人：命定天赋，降维打击！
            </span>
            <span className="px-4 py-2 bg-yellow-300 text-black font-black rounded-lg shadow-[4px_4px_0px_0px_#000] border-2 border-black">
              老职场：身价核算，血汗换钱！
            </span>
            <span className="px-4 py-2 bg-white text-black font-black rounded-lg shadow-[4px_4px_0px_0px_#000] border-2 border-black">
              应届生：避坑方向，首步必准！
            </span>
          </div>
